...
import 'package:flutterexam/util/theme_utils.dart';
...
//      _backgroundColor = ThemeUtils.getBackgroundColor(context);
      _backgroundColor = Color(0xffE6E6E6);
    } else {
              ...
              Semantics(
                ...
                child: Container(
                  ...
                  child: Text(
                      ...
                      style: TextStyle(fontSize: Dimens.font_sp20, color: Color(0xFF000000), fontWeight: FontWeight.w500)
                  ),
