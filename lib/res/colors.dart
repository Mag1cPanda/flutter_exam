...
class Colours {
  static const Color app_main = Color(0xFFFFA200);
  static const Color dark_app_main = Color(0xFFFFA200);
  ...
  static const Color button_disabled = Color(0xFFE6E6E6);
  static const Color dark_button_disabled = Color(0xFFE6E6E6);
